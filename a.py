...
[docs]class CoreNLPTagger(CoreNLPParser, TaggerI):
...
[docs]    def tag(self, sentence):
        return self.tag_sents([sentence])[0]


[docs]    def raw_tag_sents(self, sentences):
        """
...
[docs]class CoreNLPPOSTagger(CoreNLPTagger):
    """
...
[docs]class CoreNLPNERTagger(CoreNLPTagger):
    """
    This is a subclass of the CoreNLPTagger that wraps around the
